export const CtaLink = ({ text, href }: { text: string; href: string }) => {
  return (
    <a
      href={href}
      className={
        "bg-brand max-w-[fit-content] text-center font-medium transition-colors hover:bg-brand-CTAHover rounded-lg px-6 py-2 flex text-white text-xl item-center justify-center no-underline"
      }
    >
      {text}
      <svg
